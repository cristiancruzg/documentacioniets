<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewTipoDoc.aspx.cs" Inherits="Views_ViewTipoDoc" %>
...
<body>
    ...
    <div class="form-group">
            ...
            <h2 style="margin-left: 200px">Gestión de tipos de documentos</h2>
            <div class="container">
                 <div class="col-sm-6 col-md-6">
                <div class="thumbnail">
                    <!--Formulario Tipo Documento-->
                    <br />
                    <label for="inputType" class="col-md-4 control-label">Tipo de documento:</label>
                    <%-- Campo Text Box, llamando la funciona de validación de tipo de dato --%>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtTipoDoc" onkeypress="return soloLetras(event);" runat="server"></asp:TextBox>
                    </div>
                    <%-- Botón para agregar elementos--%>
                    <div class="col-md-2">
                        <asp:Button ID="btnAddTd" runat="server" Text="Agregar" CssClass="form-control btn btn btn-primary" OnClick="btnAdd_Click" Width="100px" />
                    </div>
                    <br />
                    <br />
                    ...
                    <asp:GridView ID="gvTipoDoc" CssClass="table table-bordered" runat="server"
                        ...
                        DataKeyNames="ID_TIPO_DOC" 
                        AllowPaging="True" 
                        OnPageIndexChanging="gvTipoDoc_PageIndexChanging" 
                        PageSize="20" 
                        ...
                        <asp:TemplateField HeaderText="Código"  HeaderStyle-CssClass="text-center">
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<% # Bind("ID_TIPO_DOC") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:label ID="txtId" runat="server" Text='<% # Bind("ID_TIPO_DOC") %>'></asp:label>
                            </EditItemTemplate>

<HeaderStyle CssClass="text-center"></HeaderStyle>
                        </asp:TemplateField>

                            <asp:TemplateField HeaderText="Nombre documento" HeaderStyle-CssClass="text-center">
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<% # Bind("NOMBRE_TIPO_DOC") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtNombreTd" runat="server" onkeypress="return soloLetras(event);" Text='<% # Bind("NOMBRE_TIPO_DOC") %>'></asp:TextBox>
                                </EditItemTemplate>
