<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewAnexo.aspx.cs" Inherits="Views_ViewAnexo" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="form-group">
            ...
            <h2 style="margin-left: 200px">Gestión de Anexos</h2>
            <div class="container">
                <div class="col-sm-6 col-md-6">
                    <!--thumbnail Anexo-->
                    <div class="thumbnail" contenteditable="inherit">
                        <br />
                        <label for="inputType" class="col-md-4 control-label">Nombre de Anexo:</label>
                        <%-- Campo Text Box, llamando la funciona de validación de tipo de dato --%>
                        <div class="col-md-5">
                            <asp:TextBox ID="txtNombreAnexo" onkeypress="return soloLetras(event);" runat="server"></asp:TextBox>
                        </div>
                        <%-- Botón para agregar elementos--%>
                        <div class="col-md-1">
                            <asp:Button ID="btnAddAnexo" Width="100px" runat="server" Text="Agregar" CssClass="form-control btn btn btn-primary" OnClick="btnAdd_Click" />
                        </div>
                        <br />
                        <br />
                        ...
                        <%-- Grilla con los eventos que se van a ejecutar --%>
                            <asp:GridView ID="gvAnexo" CssClass="table table-bordered" runat="server"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Código" HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<% # Bind("ID_ANEXO") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:Label ID="txtId" runat="server" Text='<% # Bind("ID_ANEXO") %>'></asp:Label>
                                        </EditItemTemplate>

                                        <HeaderStyle CssClass="text-center"></HeaderStyle>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Nombre anexo" HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
                                            <asp:Label ID="Label2" runat="server" Text='<% # Bind("NOMBRE_ANEXO") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtNombreAnexo" runat="server" onkeypress="return soloLetras(event);" Text='<% # Bind("NOMBRE_ANEXO") %>'></asp:TextBox>
                                        </EditItemTemplate>
